...
\mlenma{QC Overlap Property}{Every pair of QCs overlaps in at least $\frac{n}{3}$ nodes.}
\begin{myproof}
...
\mlenma{The inevitability of Consecutive Honest Leaders}{Assuming round-robin leader
...
First, a lemma:
\mlenma{Near-Convergence of Local Block Numbers}{Every honest node begins
...
\mlenma{Clean Rounds Commit Proposed Blocks}{Every clean round concludes
